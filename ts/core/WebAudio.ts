...
export default class WebAudio {
    public static _initialized: any;
    public static _standAlone: any;
    public static _masterVolume: number;
    public static _context: any;
    public static _masterGainNode: any;
    public static _unlocked: boolean;
    public static canPlayOgg: () => boolean;
    public static canPlayM4a: () => boolean;
    public static setMasterVolume: (value: any) => void;
    ...
    public static _fadeIn: (duration: any) => void;
    public static _fadeOut: (duration: any) => void;
    public static initialize(noAudio?: any): any {
        throw new Error("Method not implemented.");
    }
    public static _onTouchStart(): any {
        throw new Error("Method not implemented.");
    }
    public _loader: () => void;
    public _load: any;
    ...
    public play: (loop: any, offset?: any) => void;
    public stop: () => void;
    public fadeIn: (duration: any) => void;
    public fadeOut: (duration: any) => void;
    public seek: () => number;
    public addLoadListener: (listner: any) => void;
    public addStopListener: (listner: any) => void;
    public _onXhrLoad: (xhr: any) => void;
    public _startPlaying: (loop: any, offset: any) => void;
    ...
    public _onLoad: () => void;
    public _readLoopComments: (array: any) => void;
    public _readOgg: (array: any) => void;
    public _readMp4: (array: any) => void;
    public _readMetaData: (array: any, index: any, size: any) => void;
    public _readLittleEndian: (array: any, index: any) => any;
    public _readBigEndian: (array: any, index: any) => any;
    public _readFourCharacters: (array: any, index: any) => string;
