...
export default class Weather extends PIXI.Container {
    ...
    public _updateSprite: (sprite: any) => void;
    public _updateRainSprite: (sprite: any) => void;
    public _updateStormSprite: (sprite: any) => void;
    public _updateSnowSprite: (sprite: any) => void;
    public _rebornSprite: (sprite: any) => void;
    public type: string;
    public power: number;
    public origin: Point;
