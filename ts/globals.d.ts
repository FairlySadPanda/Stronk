...
declare let $plugins: import("./interfaces/IPlugin").IPlugin[];
declare let $dataActors: import("./interfaces/Actor").Actor[];
declare let $dataClasses: import("./interfaces/Class").Class[];
declare let $dataSkills: import("./interfaces/Skill").Skill[];
declare let $dataItems: import("./interfaces/Item").Item[];
declare let $dataWeapons: import("./interfaces/Weapon").Weapon[];
declare let $dataArmors: import("./interfaces/Armor").Armor[];
declare let $dataEnemies: import("./interfaces/Enemy").Enemy[];
declare let $dataTroops: import("./interfaces/Troop").Troop[];
declare let $dataStates: import("./interfaces/State").State[];
declare let $dataAnimations: import("./interfaces/Animation").Animation[];
declare let $dataTilesets: import("./interfaces/Tileset").Tileset[];
declare let $dataCommonEvents: import("./interfaces/CommonEvent").CommonEvent[];
declare let $dataSystem: import("./interfaces/System").System;
declare let $dataMapInfos: import("./interfaces/MapInfo").MapInfo[];
declare let $dataMap: import("./interfaces/Map").Map;
