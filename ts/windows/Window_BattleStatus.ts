...
export default class Window_BattleStatus extends Window_Selectable {
    ...
    public constructor() {
        super(Graphics.boxWidth - Window_BattleStatus.prototype.windowWidth(), Graphics.boxHeight - Window_BattleStatus.prototype.windowHeight(), Window_BattleStatus.prototype.windowWidth(), Window_BattleStatus.prototype.windowHeight());
        this.refresh();
        this.openness = 0;
    }
